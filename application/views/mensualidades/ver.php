                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <a class="button"
                                                        ...
                                                        <i title="Ver" class="fas fa-lg fa-fw fa-eye"
                                                            style="color: #00d41a;"></i>
                                                        <a />
                                                        ...
                                                        <a class="button"
                                                            ...
                                                            <i title="GENERAR FAC" class="fas fa-lg fa-fw fa-plus"
                                                                style="color: blue;"></i>
                                                            <a />
                                                            <?php endif; ?>
                                                            ...
                                                            <a class="button"
                                                                ...
                                                                <i title="Ver" class="fas fa-lg fa-fw fa-file"
                                                                    style="color: greem;"></i>
                                                                <a />
                                                                <?php endif; ?>
                                                                <?php if ($lista['id_status'] != 2): ?>
                                                                <a onclick="modal(<?php echo $lista['id_mensualidad']?>);"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-3">
                            ...
                            <input class="form-control" type="text" id="cantidad_pagar_otra" name="cantidad_pagar_otra"
                                onblur="calcular_dol();" onkeypress="return valideKey(event);">
                        </div>
                        <div class="form-group col-3">
